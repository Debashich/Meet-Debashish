    ...
    >
      <div className="max-w-3xl mx-auto w-full">
        ...
        <div className="text-gray-200 text-lg md:text-xl leading-relaxed space-y-6">
          <p>
            Throughout college, I've been building{" "}
            <span className="text-orange-300">backend</span> systems and
            <span className="text-orange-300"> full stack projects</span>, with
            Golang as my primary tool, with a growing interest in networking and
          ...
          <p>
            ...
            , where I help run technical events and hackathons, and I
            co‑initiated the Chess club organizing tournaments and managing
            operations taught me more about leadership and execution than any
            single course. Before SIT, I studied at Delhi Public School,
            Siliguri, where I regularly took part in inter- and intra-school
            drawing/sketching competitions, represented my school at multiple
            events, and picked up a habit of showing up consistently and
            competing seriously.
          </p>
